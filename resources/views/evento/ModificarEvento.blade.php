...
{{csrf_field()}}
<input name="id_evento" type="hidden" value={{$data->id_evento}}>
<div class="form-group">
  <label for="recinto">Recinto</label>
    <select class="form-control" id="recinto" name="recinto" value="{{$data->Ambientesid_amb}}">
  ...
  <div class="row">
  <div class="col-sm">
  <button type="submit" class="btn btn-success" style=" text-align: center;height:40px;width:200px;border-width: 0px;">Modificar Evento</button>
  </div>
  </div>
  <br>
</form>
