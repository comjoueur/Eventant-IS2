...
{{csrf_field()}}
<input id="prodId" name="prodId" type="hidden" value="aqui va el id">
  ...
  <div class="col-sm">
  <button type="submit" class="btn btn-primary" style=" text-align: center;height:40px;width:200px;border-width: 0px;">Modificar Evento</button>
  </div>
  </div>
</form>
<div class="row">
