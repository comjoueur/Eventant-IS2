...
<br>
<div class="container">
<div><h1>Modificar Actividad</h1></div>
<form action="{{route ('ModificarActividad')}}" method="post">
{{csrf_field()}}
...
<input type="text" class="form-control" id="member" name="member" value="">Numero de expositores <br>
  ...
  <div class="row">
  <div class="col-sm">
  <button type="submit" class="btn btn-success" style=" text-align: center;height:40px;width:200px;border-width: 0px;">Modificar Actividades</button>
  </div>
  </div>
  <br>
</form>
